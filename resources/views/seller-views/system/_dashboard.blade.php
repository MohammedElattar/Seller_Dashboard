                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/IT.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="Italy" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/DE.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="Germany" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/US.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="USA" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/CO.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="Columbia" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/RS.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="Srbija" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/FR.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="France" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'vendor/flag-icons/24/RU.png') }}
                                                        class="sa-language-icon d-block" alt=""
                                                        title="Russia" />
                                                </td>
                                                <td>
                                    ...
                                    <div class="sa-timeline mb-n2 pt-2">
                                        <ul class="sa-timeline__list">
                                            <li class="sa-timeline__item">
                                                <div class="sa-timeline__item-title">
                                                    Yesterday
                                                </div>
                                                <div class="sa-timeline__item-content">
                                                    Phasellus id mattis
                                                    nulla. Mauris velit
                                                    nisi, imperdiet vitae
                                                    sodales in, maximus ut
                                                    lectus. Vivamus commodo
                                                    scelerisque lacus, at
                                                    porttitor dui iaculis
                                                    id.
                                                    <a href="#">Curabitur imperdiet
                                                        ultrices
                                                        fermentum.</a>
                                                </div>
                                            </li>
                                            ...
                                            <li class="sa-timeline__item">
                                                ...
                                                <div class="sa-timeline__item-content">
                                                    Donec tempor sapien et
                                                    fringilla facilisis. Nam
                                                    maximus consectetur
                                                    diam.
                                                </div>
                                            </li>
                                            <li class="sa-timeline__item">
                                                ...
                                                <div class="sa-timeline__item-content">
                                                    Many philosophical
                                                    debates that began in
                                                    ancient times are still
                                                    debated today. In one
                                                    general sense,
                                ...
                                <ul class="list-group list-group-flush">
                                        ...
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-1-40x40.jpg') }}
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-7-40x40.jpg') }}
                                                        width="40" height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted fs-exact-13">
                                                        Reviewed by
                                                        <a href="app-customer.html" class="text-reset">Adam
                                                            Taylor</a>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-auto">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-10-40x40.jpg') }}
                                                        width="40" height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted fs-exact-13">
                                                        Reviewed by
                                                        <a href="app-customer.html" class="text-reset">Jessica
                                                            Moore</a>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-auto">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-5-40x40.jpg') }}
                                                        width="40" height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted fs-exact-13">
                                                        Reviewed by
                                                        <a href="app-customer.html" class="text-reset">Helena
                                                            Garcia</a>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-auto">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-2-40x40.jpg') }}
                                                        width="40" height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                <div class="col">
                                                    <a href="app-product.html"
                                                        class="text-reset fs-exact-14">Undefined Tool
                                                        IRadix DPS3000SY
                                                        2700 Watts</a>
                                                    <div class="text-muted fs-exact-13">
                                                        Reviewed by
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src={{ asset(env('SELLER_ASSETS_VENDOR') . 'images/products/product-16-40x40.jpg') }}
                                                        width="40" height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
