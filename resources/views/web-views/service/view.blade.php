...
@section('title',ucfirst($data['data_from']).' Service')
...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
    ...
    {{-- <div class="d-flex justify-content-center align-items-center mb-3" style="min-height: 70px;background:{{$web_config['primary_color']}}10;width:100%;">
            ...
            <div class="row text-capitalize">
                <span style="font-weight: 600;font-size: 18px; color:black">{{str_replace("_"," ",$data['data_from'])}} {{\App\CPU\translate('Services')}} {{ isset($brand_name) ? '('.$brand_name.')' : ''}}</span>
            </div>
                                            ...
                                            <div
                                                ...
                                                @foreach($category->childes as $child)
                                                    <div class="card-header p-1 flex-between">
                                                        <div>
                                                            {{-- <label class="for-hover-lable" style="cursor: pointer"
                                                                   onclick="location.href='{{route('services
                                                                   ',['id'=> $child['id'],'data_from'=>'category','page'=>1])}}'">
                                                                {{$child['name']}}
                                                            </label> --}}
                                                        </div>
                                                        <div>
            ...
            <section class="col-lg-9">
                ...
                @else
                    <div class="text-center pt-5">
                        <h2>{{\App\CPU\translate('No Services Found')}}</h2>
                    </div>
                @endif
            </section>
        </div>
