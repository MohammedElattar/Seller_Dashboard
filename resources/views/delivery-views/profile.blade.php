...
<div class="content container-fluid">
        ...
        <div class="row align-items-end">
            ...
            <div class="col-sm-auto">
                <a class="btn btn-primary btn-new"
                    href="{{route('admin-delivery.dashboard')}}">
                    <i class="tio-dashboard mr-1" style="font-size: 25px;"></i> {{\App\CPU\translate('Dashboard')}}
                </a>
            </div>
        </div>
        <!-- End Row -->
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <form action="{{route('admin-delivery.delivery-man.update',[$data->id])}}" method="post"
                ...
                <div class="card mb-3 mb-lg-5" id="generalDiv">
                    ...
                    <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                        ...
                        <img id="viewer" onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'"
                            class="avatar-img" src="{{asset('storage/app/public/delivery')}}/{{$data->photo}}"
                            alt="Image">
                    </label>
                    <!-- End Avatar -->
                </div>
                ...
                <div class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h2 class="card-title h4">{{\App\CPU\translate('Basic')}} {{\App\CPU\translate('information')}}
                        </h2>
                    </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9 row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="f_name" value="{{$data->name}}" class="form-control"
                                        id="name" required>
                                </div>
                                {{-- <div class="col-md-6">
                    ...
                    <div class="col-sm-9"><small class="text-danger">( * {{\App\CPU\translate('country_code_is_must')}}
                            {{\App\CPU\translate('like_for_BD_880')}} )</small>
                        <input type="number" class="js-masked-input form-control" name="phone" id="phoneLabel"
                            placeholder="+x(xxx)xxx-xx-xx" aria-label="+(xxx)xx-xxx-xxxxx" value="{{$data->phone}}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" class="form-control" name="email" id="newEmailLabel"
                            value="{{$data->email}}" placeholder="{{\App\CPU\translate('Enter new email address')}}"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-9" id="select-img">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="customFileUpload">{{\App\CPU\translate('image')}}
                ...
                <div class="d-flex justify-content-end">
                    <button type="button"
                        onclick="{{env('APP_MODE')!='demo'?"form_alert('seller-profile-form','Want to update Admin Delivery info ?')":"call_demo()"}}"
                        class="btn btn-primary btn-new">{{\App\CPU\translate('Save changes')}}
                    </button>
                </div>
    ...
    <div id="passwordDiv" class="card mb-3 mb-lg-5">
        ...
        <div class="card-body">
            <!-- Form -->
            <form id="changePasswordForm" action="{{route('admin-delivery.delivery-man.settings-password')}}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" class="js-pwstrength form-control" name="password" id="newPassword"
                            placeholder="{{\App\CPU\translate('Enter new password')}}" aria-label="Enter new password"
                ...
                <div class="d-flex justify-content-end">
                    <button type="button"
                        ...
                        class="btn btn-primary btn-new">{{\App\CPU\translate('Save')}}
