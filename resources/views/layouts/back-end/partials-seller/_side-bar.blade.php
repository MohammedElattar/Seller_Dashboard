            ...
            <div class="navbar-vertical-footer-offset" style="padding-bottom: 0">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @can('ORDER MANAGEMENT')
                            <li class="nav-item">
                                <small style=" font-size: 13px; font-weight: bold !important;"
                                    class="nav-subtitle">{{ \App\CPU\translate('order_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link " href="{{ route('seller.orders.list', ['out_for_delivery']) }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('out_for_delivery') }}</span>
                                            <span
                                                class="badge badge-warning badge-pill {{ Session::get('direction') === 'rtl' ? 'mr-1' : 'ml-1' }}">
                        ...
                        @can('PRODUCT MANAGEMENT')
                            <li class="nav-item">
                                <small style=" font-size: 13px; font-weight: bold !important;"
                                    class="nav-subtitle">{{ \App\CPU\translate('product_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/refund*') ? 'active' : '' }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{ Request::is('seller/refund/list/pending') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('seller.refund.list', ['pending']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li class="nav-item {{ Request::is('seller/refund/list/approved') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('seller.refund.list', ['approved']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li class="nav-item {{ Request::is('seller/refund/list/refunded') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('seller.refund.list', ['refunded']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li class="nav-item {{ Request::is('seller/refund/list/rejected') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('seller.refund.list', ['rejected']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                        ...
                        @can('BUSINESS SECTION')
                            ...
                            <li class="nav-item {{ Request::is('seller/business-settings*') ? 'scroll-here' : '' }}">
                                <small style=" font-size: 13px; font-weight: bold !important;" class="nav-subtitle"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('seller/business-settings/withdraws*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @can('roles')
                            ...
                            @if ($shipping_method == 'sellerwise_shipping')
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('seller/delivery-man*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                        href="javascript:">
