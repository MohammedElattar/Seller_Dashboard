<style>
    ...
    .nav-indicator-icon {
        margin-right: {{Session::get('direction') === "rtl" ? '6px' : ''}};
    }
</style>
                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--support section ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('business_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/sms-module')?'active':''}}">
                              ...
                              <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                           {{\App\CPU\translate('Zone')}}</span>
                                    </a>
                                </li>
                                 <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/zone*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.subscription.home') }}" title="{{ __('messages.subscription') }}">
                                        <i class="tio-city nav-icon"></i>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                           {{\App\CPU\translate('Subscription')}}</span>
                                    </a>
                                </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/shipping-cats')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.business-settings.shipping-cats.index')}}"
                                   title="{{\App\CPU\translate('shipping')}}">
                                    <i class="tio-car nav-icon"></i>
                                    <span
                                            class="text-truncate">{{\App\CPU\translate('Shipping Category')}}</span>
                                </a>
                            </li>
