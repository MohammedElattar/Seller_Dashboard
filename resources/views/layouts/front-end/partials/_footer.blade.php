...
<style>
    ...
    .instagram{
        background: #cb00dd !important;
        color: white;
    }
</style>
<div
    class="d-flex justify-content-center text-center {{Session::get('direction') === "rtl" ? 'text-md-right' : 'text-md-left'}} mt-3"
    style="background : #00000010;padding:20px;">
    {{-- <div class="col-md-1">
...
<footer class="page-footer font-small mdb-colorrtl">
    <!-- Footer Links -->
    <div style="background:#000000;padding-top:30px;">
            ...
            <div
                ...
                <div class="col-md-3 d-flex justify-content-start align-items-center footer-web-logo">
                    <a class="d-inline-block mt-n1" href="{{route('home')}}">
                        <img style="height: 150px!important; width: 270px;"
                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="col-md-5 footer-padding-bottom">
                            ...
                            <div class="text-nowrap mb-2">
                                <span
                                    style="font-weight: 700;font-size: 14.3208px;">{{\App\CPU\translate('NEWS LETTER')}}</span><br>
                                <span
                                    style="font-weight: 400;font-size: 11.066px;">{{\App\CPU\translate('subscribe to our new channel to get latest updates')}}</span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div
                                class="row d-flex align-items-center mobile-view-center-align {{Session::get('direction') === "rtl" ? ' flex-row-reverse' : ''}}">
                        ...
                        <div class="col-md-5 ">
                            <div
                                class="row pl-2 d-flex align-items-center mobile-view-center-align {{Session::get('direction') === "rtl" ? ' flex-row-reverse' : ''}}">
                                <div>
                                    <span
    ...
    <!-- Grid row -->
    <div style="background: #00000070;">
        <div class="container">
            <div class="row end-footer footer-end last-footer-content-align">
                <div class=" mt-3">
                    <p class="{{Session::get('direction') === "rtl" ? 'text-right ' : 'text-left'}}"
                       style="font-size: 12px;">{{ $web_config['copyright_text']->value }}</p>
                </div>
                <div class="mt-md-3 mt-0 mb-md-3 {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                    <div class="mt-md-3 mt-0 mb-md-3 text-right">
                       <span class="social-media ">
                           <a class="social-btn twitter ml-2 mb-2" target="_blank" href="https://www.w3schools.com/howto/howto_css_table_responsive.asp" style="color: white!important;">
                               <i style="font-size: 20px;" class="fa fa-twitter" aria-hidden="true"></i>
                           </a>
                       </span>
                        <span class="social-media">
                            <a class="social-btn ml-2 mb-2 linkedin" target="_blank"
                               href="https://dev.6amtech.com/" style="color: white!important;">
                                <i style="font-size: 20px;" class="fa fa-linkedin" aria-hidden="true"></i>
                            </a>
                        </span>
                        <span class="social-media ">
                            <a class="social-btn googleplus ml-2 mb-2" target="_blank"
                               href="https://dev.6amtech.com/" style="color: white!important;">
                                <i style="font-size: 20px;" class="fa fa-google-plus-square" aria-hidden="true"></i>
                            </a>
                        </span>
                        <span class="social-media">
                            <a class="social-btn pinterrest ml-2 mb-2" target="_blank"
                               href="https://dev.6amtech.com/" style="color: white!important;">
                                <i style="font-size: 20px;" class="fa fa-pinterest" aria-hidden="true"></i>
                            </a>
                        </span>
                        <span class="social-media ">
                            <a class="social-btn instagram ml-2 mb-2" target="_blank"
                               href="https://dev.6amtech.com/" style="color: white!important;">
                                <i style="font-size: 20px;" class="fa fa-instagram" aria-hidden="true"></i>
                            </a>
                        </span>
                        <span class="social-media ">
                            <a class="social-btn facebook ml-2 mb-2" target="_blank"
                               href="facebook.com" style="color: white!important;">
