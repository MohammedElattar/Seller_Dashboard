...
@foreach($products as $product)
    ...
    @php($rating = \App\CPU\ProductManager::get_rating($product->reviews))
    @php($productReviews = \App\CPU\ProductManager::get_product_review($product->id))
                                ...
                                <div class="cz-preview">
                                            ...
                                            <div class="cz-preview-item d-flex align-items-center justify-content-center active">
                                                <img class="show-imag img-responsive" style="max-height: 500px!important;"
                                                     ...
                                                     src="{{asset("public/app/public/product/thumbnail/")}}/{{$product['thumbnail']}}"
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                <div class="pro-group">
                                    ...
                                    <ul class="pro-price">
                                        <li>                        {{\App\CPU\Helpers::get_price_range($product) }}
                                        </li>
                                    ...
                                    <div class="revieu-box">
                                        ...
                                        <a href="review.html"><span>({{$overallRating[1]}} {{\App\CPU\translate('reviews')}})</span></a>
                                    </div>
                                    ...
                                    {{--                                            {{$countOrder}} {{\App\CPU\translate('orders')}} Ordered--}}
                                    {{--                                        </li>--}}
                                    {{--                                        <li>--}}
                                    ...
                                    {{--                                            {{$countWishlist}}  {{\App\CPU\translate('wish')}} active in Wishlist--}}
                                    {{--                                        </li>--}}
                                    {{--                                    </ul>--}}
                                </div>
                                <div class="pro-group">
                                    ...
                                    <form id="add-to-cart-form" class="mb-2">
                                        ...
                                        <div class="position-relative {{Session::get('direction') === "rtl" ? 'ml-n4' : 'mr-n4'}} mb-3">
                                            ...
                                            <div class="product-buttons">
                                                @auth('customer')
                                                <a href="javascript:void(0)" onclick="addToCart()" class="btn cart-btn btn-normal tooltip-top" data-tippy-content="Add to cart">
                                                    <i class="fa fa-shopping-cart"></i>
                                                    add to cart
                                                </a>
                                                @endauth
                                                    @guest('customer')
                                                        <a href="{{ route('customer.auth.login') }}" class="btn cart-btn btn-normal tooltip-top" data-tippy-content="Add to cart">
                                                            <i class="fa fa-shopping-cart"></i>
                                                            Login To add to cart
                                                        </a>
                                                    @endguest
                                                    <a href="{{route('product',$product->slug)}}" class="btn btn-normal tooltip-top"  data-tippy-content="view detail">
                                                    view detail
                                                </a>
                                            </div>
                                        </div>
