                    ...
                    <div class="card-header">
                        ...
                        <div class="col-12 ">
                            <div class="row flex-between justify-content-between align-items-center">
                                        ...
                                        <div class="input-group input-group-merge input-group-flush">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <i class="tio-search" style="color:#fff; font-size:19px;"></i>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-3 ">
                                    <a href="{{route('admin-delivery.delivery-man.add')}}" class="btn a btn-primary float-right"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a  class="btn btn-primary btn-sm edit"
                                            ...
                                            href="{{route('admin-delivery.delivery-man.edit',[$dm['id']])}}">
                                        ...
                                        <form action="{{route('admin-delivery.delivery-man.delete',[$dm['id']])}}"
...
@push('script_2')
    <script>
        $(document).on('change', '.status', function () {
            ...
            $.ajax({
                url: "{{route('admin-delivery.delivery-man.status-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
