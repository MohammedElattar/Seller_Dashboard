...
<head>
    ...
    <!-- Title -->
    <title style="font-family: 'Cairo', sans-serif" class="mb-30">{{\App\CPU\translate('Admin Delivery')}}</title>
    ...
    .btn-news{
        background-color: #05a165 !important;
        border-color: #05a165 !important;
        color: #fff !important;
        font-weight: bold !important;
    }
    .btn-new {
    ...
    button:hover{
        filter: drop-shadow(2px 4px 6px #05a165);
    }
    </style>
</head>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                         <form id="form-id"  action="{{route('admin-delivery.auth.logindel')}}" method="post">
                            @csrf
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <center> 
                             <h1 style="font-family: 'Cairo', sans-serif" class="mb-30">{{\App\CPU\translate('sign_in Admin Delivery')}}</h1>
                                    </center>
                                </div>
                            ...
                            <button type="submit" class="btn btn-lg btn-news btn-block">{{\App\CPU\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
...
<script src="https://cdn.jsdelivr.net/gh/FortAwesome/Font-Awesome@5.15.3/js/all.js"></script>
<!-- JS Front -->
