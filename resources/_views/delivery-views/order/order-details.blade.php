                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="{{route('admin-delivery.orders.list',['status'=>'all'])}}">{{\App\CPU\translate('Orders')}}</a>
                            </li>
                    ...
                    <div class="col-md-6 mt-2">
                        <a class="text-body mr-3" target="_blank"
                           href={{route('admin-delivery.orders.generate-invoice',[$order['id']])}}>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mt-4">
                            ...
                            @foreach($linked_orders as $linked)
                                <a href="{{route('admin-delivery.orders.details',[$linked['id']])}}"
                            ...
                            <div class="col-6 hs-unfold float-right pr-2">
                                <div class="dropdown">
                                    <select name="payment_status" class="payment_status form-control"
                                        ...
                                        <option
                                            onclick="route_alert('{{route('admin-delivery.orders.payment-status',['id'=>$order['id'],'payment_status'=>'paid'])}}','Change status to paid ?')"
                                            href="javascript:"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{route('admin-delivery.orders.update-deliver-info')}}" method="POST">
                                @csrf
        ...
        $(document).on('change', '.payment_status', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin-delivery.orders.payment-status')}}",
                        method: 'POST',
                        data: {
                            "id": id,
        ...
        function order_status(status) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin-delivery.orders.status')}}",
                        method: 'POST',
                        data: {
                            "id": '{{$order['id']}}',
                            "order_status": status
...
<script>
    ...
    <script>
        function addDeliveryMan(id) {
            $.ajax({
                type: "GET",
                url: '{{url('/')}}/admin-delivery/orders/add-delivery-man/{{$order['id']}}/' + id,
                data: {
                    'order_id': '{{$order['id']}}',
                    'delivery_man_id': id
                },
